...
#-------------------------------------------------------
#start here
# 数据集 change to your data directory
#tf.flags.DEFINE_string("data_directory", "/media/bruinx/1a94415f-480b-4282-a57a-3c1d1df10747/yunxiang/WorkSpace", "Data directory.")
#tf.flags.DEFINE_string("data_directory", "./", "Data directory.")
#-------------------------------------------------------
...
with tf.name_scope("loss"):
    loss = tf.reduce_mean(tf.nn.sigmoid_cross_entropy_with_logits(logits=scores, targets=input_y))
